        ...
        $(function() {
                            ...
                            for(k in obj) {
                                ...
                                if(k=='list') {
                                    ...
                                    if(obj[k]==null) {
                                        ...
                                        var noexit=$("<div class='noexit'>暂未查询到已申请任务</div>");
                                        ...
                                        for(var i=0;i<obj1.length;i++) {
                                            ...
                                            var tds8=$("<td style='color:#00a400;border-right:none;font-weight: bold'>审批中</td>");
                            ...
                            for(k in obj) {
                                ...
                                if(k=='list') {
                                    ...
                                    if(obj[k]==null) {
                                        ...
                                        var noexit=$("<div class='noexit'>暂未查询到已处理任务</div>");
                                            ...
                                            for(j in obj2) {
                                                ...
                                                if(j=='flowinfoid') {
                                                    ...
                                                    if(obj2[j]==1) {
                                                        ...
                                                        tds8.css({"font-weight":"bold","color":"#00b600"});
                                                        tds8.text("已同意");

                                                    }else {

                                                        tds8.css({"font-weight":"bold","color":"#dd0000"});
                                                        tds8.text("已拒绝");
            ...
            $(document).on('click','.flows',function() {
                ...
                if(v=='付款单审批流程') {
                    ...
                    window.open("${pageContext.request.contextPath}/climpfilterpageie8.do","_blank");

                }else if(v=='维修保养流程') {

                    window.open("${pageContext.request.contextPath}/climptorepaireie8.do","_blank");

                }else if(v=='设备类采购流程') {

                    window.open("${pageContext.request.contextPath}/climpdevicepageie8.do","_blank");

                }else if(v=='一致性药品采购流程') {

                    window.open("${pageContext.request.contextPath}/climpotherpageie8.do","_blank");
            ...
            $(document).on('click','.flopic',function() {
                ...
                form.attr({"action":"${pageContext.request.contextPath}/climpflowpicbyfid.do"});
