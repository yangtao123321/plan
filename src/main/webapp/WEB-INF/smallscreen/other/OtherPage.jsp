...
<div class="top">
    ...
    <span class="title" style="font-size: 21px">一致性药品采购类流程</span>
...
<div class="mai">
    ...
    <table class="bydetailtb">

        <tr>

            <td width="7%" style="border-left: 1px solid #dfe1e5">品名<span style="color: red">*</span></td>
            <td width="15%"><input style="font-size: 13px" class="productname" type="text" /></td>
            <td width="5%">厂家</td>
            <td width="20%"><input style="font-size: 13px" class="productsupplier" type="text" /></td>
            <td width="5%">规格</td>
            <td width="20%"><input style="font-size: 13px" class="productspecial" type="text" /></td>
            <td width="5%">数量<span style="color: red">*</span></td>
            <td width="7%"><input style="font-size: 13px" class="productnum" type="text" /></td>
            <td width="21%" style="border-right: 1px solid #dfe1e5"><input class="cancel" type="button" value="取消" /> <input class="add" type="button" value="添加" /></td>
