...
<div class="mai">
    ...
    <table class="appdetailtb">
        ...
        <tr>
            <td width="6%" style="border-left:1px solid #cad0cc">名称<span style="color: red">*</span></td>
            <td width="14%">
                <select class="fname">
            ...
            <td width="6%">尺寸<span style="color: red">*</span></td>
            <td width="14%">
                <select class="fsize">
    ...
    <table class="filterlist">
        ...
        <tr style="font-weight: bold;color: #0f0f0f">
    ...
    <input class="filterclose" style="font-family: 楷体" type="button" value="关闭" />

    <input class="filtersave" style="font-family: 楷体" type="button" value="提交" />
