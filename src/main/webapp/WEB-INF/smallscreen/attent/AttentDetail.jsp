...
<div class="mai">
    ...
    <table class="tb">
        ...
        <tr>
            ...
            <td width="20%" style="background-color: white">${attentplan.user.truename}</td>
            <td width="10%">提报人</td>
            <td width="15%" style="background-color: white">${attentplan.applyperson}</td>
            <td width="10%">申请时间</td>
            <td width="25%" style="background-color:white;border-right: none">${attentplan.applytime}</td>
        </tr>

        <tr>

            <td style="border-left: none">流程内容摘要</td>
            <td colspan="2" style="background-color: white">${attentplan.applyabstract}</td>
    ...
    <div style="font-weight: bold;margin-top: 1%;margin-left: 1%;margin-bottom: 1%">申请原因</div>
        ...
        <c:otherwise>
            ...
            <table class="tb1">
                ...
                <tr>
                    ...
                    <td width="45%" style="border-right: none">规格</td>
