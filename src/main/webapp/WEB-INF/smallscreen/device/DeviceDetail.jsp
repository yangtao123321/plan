...
<div class="mai">
    ...
    <div style="font-weight: bold;margin-top: 1%;margin-left: 1%;font-family: 楷体;font-size: 16px">申请信息</div>
    ...
    <div style="font-weight: bold;margin-top: 1%;margin-left: 1%;font-family: 楷体">采购原因</div>

    <textarea class="buyreason">${deviceplan.buyreson}</textarea>

    <div style="font-weight: bold;margin-top: 3%;margin-left: 1%;font-family: 楷体;font-size: 15px">采购详情</div>
    ...
    <div style="clear: left;font-weight: bold;margin-top: 1%;margin-left: 1%;font-family: 楷体;font-size: 15px">审批记录</div>
            ...
            <c:choose>
                ...
                <c:when test="${approve.user.position.posid==1}">
                    ...
                    <tr style="font-size: 15px">
                        ...
                        <td style="font-family: 楷体;color: #e074a2;font-weight: bold">${approve.suggest}</td>
