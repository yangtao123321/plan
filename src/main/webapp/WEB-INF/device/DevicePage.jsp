    ...
    <script type="text/javascript" language="JavaScript">
        ...
        $(function() {
            ...
            $(document).on('click','.filtersave',function() {
                ...
                var devicerequire=$(".devicerequireval").val().trim();
                ...
                if(person!=''&&abstract!=''&&reason!=''&&receive!='0') {//第一次校验通过了,开始进行第二次的校验
                    ...
                    if(saveDataAry.length==0) {
                        ...
                        $.ajax({
                            ...
                            type:"post",
                            async:false,
                            data:{"details":JSON.stringify(saveDataAry),"user.uid":uid,"devicetitle":devicetitle,"applyperson":person,"applyabstract":abstract,"receive":receive,"applytime":startime,"buyreson":reason,"flowid":flowid,"devicerequire":devicerequire},
                            dataType:"json",
...
<div class="top">
    ...
    <span class="title">购买设备类计划申请页</span>
...
<div class="mai">
    ...
    <div class="devicerequire">设备采购要求</div>

    <input class="devicerequireval" style="border-left: 1px solid #babcc0;border-right: 1px solid #babcc0" type="text" />
