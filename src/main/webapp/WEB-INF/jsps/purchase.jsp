        ...
        $(function() {
                                ...
                                if(k=='list') {
                                    ...
                                    if(obj[k]==null) {
                                        ...
                                        for(var i=0;i<obj1.length;i++) {
                                            ...
                                            var tds2=$("<td style='font-family: 楷体'></td>");
                                            var tds3=$("<td class='flowabstract'></td>");
                                            var tds4=$("<td></td>");
                                            var tds5=$("<td style='font-family: 楷体'></td>");
                                            var tds6=$("<td style='font-family: 楷体'></td>");
                                            ...
                                            var tds8=$("<td style='color:#e78d7a;border-right:none;font-weight: bold;font-family: 楷体'>审批中</td>");
                                            ...
                                            for(j in obj2) {
                                                ...
                                                if(j=='flowinfoid') {
                                                    ...
                                                    if(obj2[j]==1) {
                                                        ...
                                                        tds8.css({"font-weight":"bold","color":"#00b600","font-family":"楷体"});
                                                        tds8.text("已同意");

                                                    }else {

                                                        tds8.css({"font-weight":"bold","color":"#dd0000","font-family":"楷体"});
                                                        tds8.text("已拒绝");
            ...
            $(document).on('click','.flows',function() {
                ...
                if(v=='付款单审批流程') {
                    ...
                    window.open("${pageContext.request.contextPath}/climpattentpage.do","_blank");
                            ...
                            if(k=='list') {
                                ...
                                if(obj[k]==null) {
                                    ...
                                    for(var i=0;i<obj1.length;i++) {
                                        ...
                                        var tds8=$("<td style='color:#dd8770;border-right: none;font-weight:bold;font-family:楷体'>审批中</td>");
