                            ...
                            for(k in obj) {
                                ...
                                if(k=='list') {
                                    ...
                                    if(obj[k]==null) {//不存在待办任务
                                        ...
                                        var noexit=$("<div class='noexit'>暂未查询到待办任务</div>");
                                            ...
                                            for(j in obj2) {
                                                ...
                                                if(j=='flowinfoid') {
                                                    ...
                                                    if(obj2[j]==0) {
                                                        ...
                                                        tds8.css({"font-weight":"bold","color":"#e78d7a","font-family":"楷体"});
                                                        tds8.text("处理中");
