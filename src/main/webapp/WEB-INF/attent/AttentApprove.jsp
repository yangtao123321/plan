...
<div class="mai">
    ...
    <div style="font-weight: bold;margin-top: 1%;margin-left: 1%;font-size: 16px">采购原因</div>

    <textarea class="reason">${attentplan.buyreson}</textarea>
    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <div style="font-weight: bold;margin-top: 3%;margin-left: 1%;font-size: 16px">采购详情</div>

            <table class="tb1">

                <tr>
                    <td width="45%" style="border-left: none">品名</td>
                    <td width="45%">规格</td>
                    ...
                    <tr>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${approve.user.position.posid==2}">
                                ...
                                <td>${approve.dealtime}</td>
                                <td style="font-family: 楷体;color: #ff2a45;background-color: white;font-weight: bold">${approve.suggest}</td>
