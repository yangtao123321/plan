        ...
        $(function() {
            ...
            $(".add").click(function() {
                ...
                if(fname!='请选择'&&fsize!='请选择'&&fdgree!='请选择'&&finterface!='请选择'&&fherpin!='请选择'&&num!='') {
                    ...
                    var td1=$("<td style='border-left:1px solid #e9e8e7'>"+fname+"</td>");
                    var td2=$("<td>"+fsize+"</td>");
                    ...
                    var td7=$("<td style='border-right:1px solid #e9e8e7'><input class='del' type='button' value='删除' /></td>");
    ...
    <style type="text/css">
        ...
        *{
        ...
        .apptb td,.appdetailtb td,.caigouyaoqiu td{
            ...
            font-family: "楷体";
            border: 1px solid rgba(171, 173, 177, 0.65);
            text-align: center;
            height: 40px;
            font-size: 15px;
...
<div class="mai">
    ...
    <table class="apptb">
        ...
        <tr>
            <td width="15%" style="border-left:1px solid #e9e8e7">申请单位</td>
            <td width="30%">${sessionScope.get("userinfo").department.deptname}</td>
            <td width="15%">提报人<span style="color: red">*</span></td>
            <td width="30%" style="border-right:1px solid #e9e8e7"><input class="apperson" type="text" /></td>
        </tr>

        <tr>

            <td width="15%" style="border-left:1px solid #e9e8e7">申请原因<span style="color: red">*</span></td>
            <td colspan="3" style="border-right:1px solid #e9e8e7"><input class="appreason" type="text" /></td>

        </tr>

        <tr>
            <td width="15%" style="border-left:1px solid #e9e8e7">计划名称<span style="color: red">*</span></td>
            <td width="30%"><input class="abstract" type="text" /></td>
            <td width="15%">发起时间</td>
            <td width="30%" style="border-right:1px solid #e9e8e7"><input readonly="true" class="startime" type="text" value="${requestScope.get("starttime")}" /></td>
        </tr>
    ...
    <table class="appdetailtb">
        ...
        <tr>
            <td width="5%" style="border-left:1px solid #e9e8e7">名称<span style="color: red">*</span></td>
            <td width="15%">
                <select class="fname">
            ...
            <td width="15%" style="border-right:1px solid #e9e8e7">
        ...
        <tr>
            <td width="5%" style="border-left:1px solid #e9e8e7">膜层数<span style="color: red">*</span></td>
            <td width="15%">
            ...
            <td colspan="2" style="border-right:1px solid #e9e8e7"><input class="cancel" type="button" value="取消" /><input class="add" type="button" value="添加" /></td>
    ...
    <table class="caigouyaoqiu">
        ...
        <tr>
            <td width="10%" style="font-weight: bold;font-family: 楷体;border-left:1px solid #e9e8e7;font-size: 15px">生产厂家</td>
            <td style="border-right:1px solid #e9e8e7">
    ...
    <table class="filterlist">
        ...
        <tr style="font-weight: bold;color: #000000">
            <td width="15%" style="border-left:1px solid #e9e8e7">名称</td>
            <td width="15%">尺寸</td>
            <td width="15%">精度</td>
            <td width="15%">接口</td>
            <td width="25%">膜层数</td>
            <td width="10%">数量</td>
            <td width="5%" style="border-right:1px solid #e9e8e7">操作</td>
