...
<div class="mai">
    ...
    <table class="tb">
        ...
        <tr>
            ...
            <td width="20%" class="a">${otherplan.user.truename}</td>
            <td width="10%">提报人</td>
            ...
            <c:choose>
                ...
                <c:when test="${approve.user.position.posid==1}">
                    ...
                    <tr>
                        ...
                        <td style="border-right: none;height: 60px;"></td>
                    ...
                    <tr>
                        ...
                        <c:choose>
                            ...
                            <c:when test="${approve.user.position.posid==2}">
                                ...
                                <td>${approve.dealtime}</td>
                                <td style="font-family: 楷体;color: #ff2a45;background-color: white;font-weight: bold">${approve.suggest}</td>
                                <td style="border-right: none;height: 60px"><img width="100%" height="100%" src="${pageContext.request.contextPath}${approve.signature}" /></td>
