 ...
 */
public class TextMail1 {

    //发送邮件功能  带附件发送
    public static void sendMail(String send,String psd,String host,User user,String cc,String subject,String content) throws Exception {
        ...
        MimeMessage message = createMimeMessage(session, send, user,cc,subject,content);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, User user,String cc,String subject,String content) throws Exception {
